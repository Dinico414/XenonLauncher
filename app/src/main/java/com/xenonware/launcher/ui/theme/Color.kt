...
// Notes-style Extended Colors (simplified as requested, only the extended ones)
...
val inverseErrorDark = Color(0xFFF2B8B5)
val inverseOnErrorDark = Color(0xFF601410)
val inverseErrorContainerDark = Color(0xFF8C1D18)
val inverseOnErrorContainerDark = Color(0xFFF9DEDC)


val inverseErrorLight = Color(0xFFB3261E)
val inverseOnErrorLight = Color(0xFFFFFFFF)
val inverseErrorContainerLight = Color(0xFFF9DEDC)
val inverseOnErrorContainerLight = Color(0xFF410E0B)
